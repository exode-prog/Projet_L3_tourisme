...
const Plage = () => {
  ...
  useEffect(() => {
    axios.get("http://192.168.3.11:4000/plage") 
      .then(response => {
        setPlages(response.data); // ✅ plus besoin de filtrer ici
      })
  ...
  return (
    <div className="min-h-screen bg-blue-50 py-12 px-4 md:px-10">
      <h1 className="text-4xl font-bold text-center text-blue-800 mb-10">Plages Magnifiques à Découvrir</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
        {plages.map((plage, index) => (
          <div key={index} className="bg-white p-6 rounded-xl shadow-md">
            ...
            />
            <h2 className="text-2xl font-semibold text-gray-700">{plage.ville}, {plage.pays}</h2>
